...
async fn manifest_matches_remote_module_protocol() {
    ...
    assert_eq!(
        manifest["console"][0]["label"],
        console_surface_contract["label"]
    );
    assert_eq!(
        manifest["console"][0]["area"],
        console_surface_contract["area"]
    );
    assert_eq!(
        manifest["console"][0]["route"],
        console_surface_contract["route"]
    );
    assert_eq!(
    ...
    assert_eq!(
        manifest["console"][0]["icon"],
        console_surface_contract["icon"]
    );
    assert_eq!(
        manifest["console"][0]["required_capabilities"],
        console_surface_contract["requiredCapabilities"]
    );
    assert_eq!(
    ...
    assert_eq!(
        manifest["console"][0]["navigation"]["order"],
        console_surface_contract["navigation"]["order"]
    );
