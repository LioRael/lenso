...
- Read [`CONTEXT.md`](CONTEXT.md), [`docs/adr/README.md`](docs/adr/README.md),
  ...
  the relevant ADR 0030–0076 before changing architecture. Read ADR 0076 and
  the execution target capability matrix for Environment, Infrastructure, or
  target-admission work.
