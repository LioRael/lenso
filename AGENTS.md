...
- `crates/platform-*`: shared platform primitives for config, HTTP, runtime, the domain descriptor, the Runtime Console observability backend (`platform-admin`), testing, migrations, outbox, errors, health, and telemetry.
