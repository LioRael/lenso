...
use platform_module::{
    ...
    AdminEmbeddedSurface, AdminMetricBinding, AdminSandboxPolicy, AdminSchema,
    CONSOLE_BRIDGE_PROTOCOL, ConsoleNavigation, ConsoleSurface, ConsoleSurfacePresentation,
    ConsoleWorkspaceRef, EntitySchema, EventHandlerDeclaration, EventSurface, FieldSchema,
