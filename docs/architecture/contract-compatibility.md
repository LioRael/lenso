...
business-event shapes. Config comparison covers required values, sensitivity, scope, mutability,
and activation requirements. Reliability comparison is conservative: declaration changes require
review and never claim that Lenso enforces availability, latency, health, backlog, error-budget, or
rollout expectations at runtime.
