...
- `lenso@0.3.2` is the first crates.io candidate that publishes the `host`
  dependency chain.
...
| 4 | `lenso` crates.io crate | `0.3.2` | `lenso` | Facade for current module-authoring contracts and the crates.io `host` feature. |
