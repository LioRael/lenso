...
- `lenso@0.3.8` is the current crates.io facade line with the `host`
  dependency chain.
...
| 4 | `lenso` crates.io crate | `0.3.8` | `lenso` | Facade for current module-authoring contracts and the crates.io `host` feature. |
