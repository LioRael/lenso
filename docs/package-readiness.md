...
- `lenso-contracts@0.3.1` is the next crates.io publish candidate.
...
| 3 | `lenso` Git crate | `0.3.1` | `lenso` | Facade for current module-authoring contracts and the Git-only `host` feature. |
