...
use lenso_autonomous_service::{
    DeliveryFailureReason, LocalTransportAdapter, ServiceEventAdmission, ServiceEventHandler,
    ServiceEventHandlerError, ServiceEventPublisher, ServiceEventRetryPolicy, TransportAdapter,
...
use lenso_service::{
    ...
    GeneratedEventContract, ServiceContextPolicy, ServiceTenancyMode,
    SystemSandboxDelegatedContextProvider, SystemSandboxWorkloadIdentityProvider,
    TenantCredentialRequest, WorkloadCredentialRequest, WorkloadIdentityProvider, WorkloadRole,
