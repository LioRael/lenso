...
use lenso_service::{
    ...
    system_plane::{
        RUNTIME_OBSERVABILITY_PROTOCOL, RuntimeObservabilityStatus, runtime_observability_schema,
        runtime_observability_schema_digest,
    },
};
use platform_runtime_observability::{RuntimeObservabilityProvider, router};
