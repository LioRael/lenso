...
impl NativeModuleInstance {
    ...
    pub fn new(endpoints: Vec<Rc<dyn NativeRequestEndpoint>>) -> Self {
        Self::with_all_endpoints(endpoints, Vec::new(), Vec::new(), NoopModuleLifecycle)
    }
    ...
    /// Creates a generation with request, stream, Event, and lifecycle endpoints.
    ...
    pub fn with_endpoints(
        ...
        Self::with_all_endpoints(endpoints, stream_endpoints, Vec::new(), lifecycle)
    }
    ...
    /// Returns the exact ephemeral Event endpoint set created for this generation.
